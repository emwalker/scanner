...
#[derive(Debug, Clone)]
pub struct HardwareLifecycleComponent {
    pub added_at: Instant,
    pub backend: Backend,
    pub num_tuners: usize,
}

impl HardwareLifecycleComponent {
...
mod tests {
    ...
    fn test_lifecycle_creation() {
        let lifecycle = HardwareLifecycleComponent::new(Backend::Mock, 2);
    ...
    fn test_lifecycle_age() {
        let lifecycle = HardwareLifecycleComponent::new(Backend::Mock, 1);
