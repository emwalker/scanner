...
impl ColorScheme for DuneDarkTheme {
...
/// Dune light theme - bright desert day with deep spice accents
pub struct DuneLightTheme;

impl ColorScheme for DuneLightTheme {
    fn primary(&self) -> Color {
