...
mod tests {
    ...
    fn test_cfar_threshold_adapts_to_noise_level() {
        ...
        let low_noise_peaks =
            crate::peaks::collect_peaks_from_source(&config, &mut low_noise_generator)
        ...
        let high_noise_peaks =
            crate::peaks::collect_peaks_from_source(&config, &mut high_noise_generator)
    ...
    fn test_cfar_resists_strong_signal_masking() {
        ...
        let baseline_clean_peaks =
            crate::peaks::collect_peaks_from_source(&baseline_config, &mut clean_generator)
        ...
        let baseline_interfered_peaks =
            crate::peaks::collect_peaks_from_source(&baseline_config, &mut interfered_generator)
        ...
        let cfar_interfered_peaks =
            crate::peaks::collect_peaks_from_source(&cfar_config, &mut cfar_interfered_generator)
