...
mod tests {
    use super::*;
    use crate::pool::{Pool, PoolFilter, Segment, TaskPriority, TaskRequirements, TunerActivity};
    ...
    fn test_switch_between_stations_releases_tuner() {
        ...
        let device_info = crate::sdr::DeviceInfo {
            id: crate::sdr::DeviceId::from_serial("mock", "test-device"),
        ...
        let signal_1 = crate::types::Signal {
            frequency_hz: 88_900_000.0,
            signal_strength: 0.8,
            ...
            audio_quality: crate::audio_quality::AudioQuality::Good,
        };
        ...
        let signal_2 = crate::types::Signal {
