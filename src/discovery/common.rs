...
mod tests {
    ...
    fn test_detect_no_changes() {
        ...
        devices.insert(DeviceId::from_serial("test", "001"), DeviceInfo {
            ...
            tuners: vec![crate::hardware::types::TunerInfo {
                ...
                mode: String::new(),
                antenna: None,
                id: crate::hardware::pool::TunerId::new(DeviceId::from_serial("test", "001"), 0),
            }],
        });
    ...
    fn test_detect_added_devices() {
        ...
        current.insert(DeviceId::from_serial("test", "001"), DeviceInfo {
            id: DeviceId::from_serial("test", "001"),
        ...
        current.insert(DeviceId::from_serial("test", "002"), DeviceInfo {
            ...
            tuners: vec![crate::hardware::types::TunerInfo {
                ...
                mode: String::new(),
                antenna: None,
                id: crate::hardware::pool::TunerId::new(DeviceId::from_serial("test", "002"), 0),
            }],
        });
    ...
    fn test_detect_removed_devices() {
        ...
        known.insert(DeviceId::from_serial("test", "001"), DeviceInfo {
            id: DeviceId::from_serial("test", "001"),
            label: "Test Device 1".to_string(),
            tuners: vec![crate::hardware::types::TunerInfo {
                label: "Test Device 1".to_string(),
        ...
        known.insert(DeviceId::from_serial("test", "002"), DeviceInfo {
            id: DeviceId::from_serial("test", "002"),
            label: "Test Device 2".to_string(),
            tuners: vec![crate::hardware::types::TunerInfo {
                label: "Test Device 2".to_string(),
    ...
    fn test_detect_changes_deterministic_ordering() {
        ...
        for i in (0..10).rev() {
            ...
            current.insert(id.clone(), DeviceInfo {
                id: id.clone(),
